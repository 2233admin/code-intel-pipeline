...
`legacy/run-code-intel.ps1`. Its stable branch id is
...
```powershell
pwsh -NoProfile -File legacy/tools/compatibility/Test-HospitalRetirementBoundary.ps1
pwsh -NoProfile -File legacy/tools/compatibility/New-HospitalRetirementPacket.ps1 `
...
pwsh -NoProfile -File legacy/tools/compatibility/Test-HospitalRetirementPacket.ps1 `
