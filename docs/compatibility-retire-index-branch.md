...
`legacy/update-code-intel-index.ps1`. Its stable branch id is
...
```powershell
pwsh -NoProfile -File legacy/tools/compatibility/Test-IndexRetirementBoundary.ps1
pwsh -NoProfile -File legacy/tools/compatibility/New-IndexRetirementPacket.ps1 `
  -OutDir orchestration/retirements/e10-index -EvaluatedAt <unix-seconds> `
  -CodeIntel work/e01-review-target/debug/code-intel.exe
pwsh -NoProfile -File legacy/tools/compatibility/Test-IndexRetirementPacket.ps1 `
