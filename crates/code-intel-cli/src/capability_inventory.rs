...
pub(crate) mod workflow_recommendation;
...
pub(crate) fn execute(
    ...
    match adapter {
        ...
        "advisory.workflow-recommend.compat" => {
            workflow_recommendation::execute_v1(request, verified_inputs, out)
        }
        "advisory.workflow-recommend-v2.native" => {
            workflow_recommendation::execute_v2(request, verified_inputs, out)
        }
