//! The `provider <name>-adapt` and `provider file-boundary`/`runtime-ci-evidence`
//! routes: split out of `routes/mod.rs` for the same god-file reason
//! `run_routes`/`edit_routes` were (#301 tipped it over 800 lines by adding
