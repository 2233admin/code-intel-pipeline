...
#
# Run:
#   pwsh -File test-regression-fixes.ps1
#   pwsh -File test-regression-fixes.ps1 -VerboseOutput
#
...
# style already used by test-code-intel-pipeline.ps1, but adds pass/fail counting
